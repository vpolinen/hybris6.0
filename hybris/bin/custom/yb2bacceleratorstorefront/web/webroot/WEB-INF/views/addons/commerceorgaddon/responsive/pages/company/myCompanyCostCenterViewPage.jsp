            ...
            <div class="accountActions-link clearfix">
                <div class="col-sm-12">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="${enableCostCenterUrl}" class="button enable-link">
            ...
            <div class="account-list">
                <div class="account-list-header">
                    ...
                    <div class="account-list-header-add pull-right">
                        <a href="${selectBudgetsForCostcenterUrl}" class="button add">
                            <spring:theme code="text.company.costCenter.addBudgetButton.displayName"/>
                        </a>
                    </div>
                </div>
