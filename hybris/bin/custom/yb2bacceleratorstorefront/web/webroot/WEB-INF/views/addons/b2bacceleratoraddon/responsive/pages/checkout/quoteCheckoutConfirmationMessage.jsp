    ...
    <div class="checkout-success-body">
        <c:choose>
            <c:when test="${orderData.status == 'CANCELLED'}">
                <div class="checkout-success-body-headline"><spring:theme code="order.quoteRequest.cancelled.confirmation" arguments="${orderData.code}"/></div>
            </c:when>
            <c:otherwise>
                <div class="checkout-success-body-headline"><spring:theme code="order.quoteRequest.thankYou"/></div>
                <p>
