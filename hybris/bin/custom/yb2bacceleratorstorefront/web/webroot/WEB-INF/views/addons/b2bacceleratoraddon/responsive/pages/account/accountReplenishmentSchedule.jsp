                    ...
                    <c:forEach items="${searchPageData.results}" var="replenishment">
                        ...
                        <tr class="responsive-table-item">
                            ...
                            <td class="responsive-table-cell" data-lebal2="${cancelReplenishmentUrl}" >
                                ...
                                <%--<div class="replenishment-cancel-container col-xs-6 hidden-sm hidden-md hidden-lg">--%>
                                    <%--<ycommerce:testId code="replenishment_Actions_links">--%>
                                        <%--<c:if test="${replenishment.active}">--%>
                                            <%--<a href="#" class="replenishment-cancel-button js-replenishment-cancel-button responsive-table-ink" data-job-code="<c:out value='${replenishment.jobCode}'/>"--%>
                        ...
                        <div class="hidden">
                            <div id="popup_confirm_replenishment_order_cancellation_${replenishment.jobCode}" class="replenishment-order-cancel-modal">
