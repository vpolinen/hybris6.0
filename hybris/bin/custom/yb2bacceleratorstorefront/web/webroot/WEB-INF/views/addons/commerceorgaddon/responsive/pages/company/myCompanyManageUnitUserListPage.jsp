...
<template:page pageTitle="${pageTitle}">
	...
	<script id="enableDisableLinksTemplate" type="text/x-jquery-tmpl">
        {{if selected}}
            <a href="#" url="${membersActionLink}/deselect/?user={{= id}}&role=${ycommerce:encodeUrl(param.role)}" class="action-links js-deselectUser"><span class="glyphicon glyphicon-ok"></span></a>
        {{else}}
            <a href="#" url="${membersActionLink}/select/?user={{= id}}&role=${ycommerce:encodeUrl(param.role)}" class="action-links js-selectUser"><span class="glyphicon glyphicon-ok"></span></a>
        {{/if}}
    </script>
