...
<template:page pageTitle="${pageTitle}">
	...
	<script id="enableDisableLinksTemplate" type="text/x-jquery-tmpl">
		{{if selected}}
			<a href="#" url="${actionLink}/deselect/?permission={{= id}}&usergroup=${ycommerce:encodeUrl(param.usergroup)}" class="action-links js-deselectLink"><span class="glyphicon glyphicon-ok"></span></a>
		{{else}}
			<a href="#" url="${actionLink}/select/?permission={{= id}}&usergroup=${ycommerce:encodeUrl(param.usergroup)}" class="action-links js-selectLink"><span class="glyphicon glyphicon-ok"></span></a>
		{{/if}}
	</script>
