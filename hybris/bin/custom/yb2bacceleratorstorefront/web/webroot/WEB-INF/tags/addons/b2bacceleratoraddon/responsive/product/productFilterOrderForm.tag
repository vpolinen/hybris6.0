...
<li class="product-item clearfix">
    ...
    <div class="details create-order-form-details">
        <div>
            ...
            <div class="col-sm-5 col-md-4 details-price-wrap">
                <spring:theme code="basket.page.itemPrice"/>:
                <span class="price"><b><product:productListerItemPrice product="${product}"/></b></span>
            </div>
        </div>
    </div>
    <div class="details create-order-form-variants">
        <div>
            <div class="col-sm-7">
                <div class="product-id-checkbox">
