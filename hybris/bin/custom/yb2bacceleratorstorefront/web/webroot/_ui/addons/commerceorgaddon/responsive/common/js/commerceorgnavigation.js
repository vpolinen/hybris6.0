ACC.myCompanyNavigation = {
    ...
    myCompanyNavigation: function(){
        ...
        var oMMainNavDesktopCom = $(".accNavComponentCompany > ul");
        ...
        if(oUserInfo && oUserInfo.length === 1 && oMyCompanyData.length > 0)
        {
            ...
            var myCompanyHook = $('<a class=\"myCompanyLinksHeader collapsed js-myCompany-toggle\"  data-toggle=\"collapse\" data-parent=".md-secondary-navigation" href=\"#accNavComponentDesktopTwo\">' + oMyCompanyData.data("title") + '</a>' );
