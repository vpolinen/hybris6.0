...
@Controller
@Scope("tenant")
@RequestMapping(value = "/checkout/quote")
public class CheckoutQuoteController extends AbstractCheckoutController
{
	protected static final Logger LOG = Logger.getLogger(CheckoutQuoteController.class);
	/**
	...
	private static final String CHECKOUT_QUOTE_CONFIRMATION_CMS_PAGE_LABEL = "quoteConfirmation";
	...
	protected String processOrderCode(final String orderCode, final Model model) throws CMSItemNotFoundException
	{
		...
		final AbstractPageModel cmsPage = getContentPageForLabelOrId(CHECKOUT_QUOTE_CONFIRMATION_CMS_PAGE_LABEL);
		storeCmsPageInModel(model, cmsPage);
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId(CHECKOUT_QUOTE_CONFIRMATION_CMS_PAGE_LABEL));
