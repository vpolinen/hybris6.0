 ...
 *
 */
package de.hybris.platform.ebookb2bacceleratorstorefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('ebookb2bacceleratorstorefront.generic.cms.component.controller.authorized.group')}")
