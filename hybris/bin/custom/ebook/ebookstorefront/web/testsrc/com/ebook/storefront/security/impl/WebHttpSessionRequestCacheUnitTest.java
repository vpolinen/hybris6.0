...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ebookstorefront/electronics/en",
						"https://electronics.local:9002/ebookstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ebookstorefront/electronics/en",
						"https://electronics.local:9002/ebookstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ebookstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ebookstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ebookstorefront/electronics/en",
						"https://electronics.local:9002/ebookstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ebookstorefront",
						"https://electronics.local:9002/ebookstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ebookstorefront",
						"https://electronics.local:9002/ebookstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ebookstorefront/electronics/en",
						"https://electronics.local:9002/ebookstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
