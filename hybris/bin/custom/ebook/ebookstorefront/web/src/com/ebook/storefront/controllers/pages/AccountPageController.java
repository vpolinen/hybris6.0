...
import com.ebook.storefront.forms.validator.EbookProfileUpdateValidator;
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	@Resource(name = "ebookProfileValidator")
	private EbookProfileUpdateValidator ebookProfileValidator;
	...
	protected EbookProfileUpdateValidator getProfileValidator()
	{
		return ebookProfileValidator;
	}
	...
	public String editProfile(final Model model) throws CMSItemNotFoundException
	{
		...
		final CustomerData customerData = customerFacade.getCurrentCustomer();
		final EbookUpdateProfileForm updateProfileForm = new EbookUpdateProfileForm();
		...
		updateProfileForm.setCurrentLocation(customerData.getCurrentLocation());
