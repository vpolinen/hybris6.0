 ...
 *
 */
package com.ebook.storefront.controllers.misc;
...
import com.ebook.facades.customer.impl.EbookDefaultCartFacade;
import com.ebook.storefront.controllers.ControllerConstants;
import com.ebook.storefront.forms.EbookAddToCartForm;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "ebookstorefront.storefront.minicart.shownProductCount";
	...
	@Resource(name = "ebookDefaultCartFacade")
	private EbookDefaultCartFacade ebookDefaultCartFacade;
	...
	public String addToCart(@RequestParam("productCodePost") final String code, final Model model,
			@Valid final EbookAddToCartForm form, final BindingResult bindingErrors)
	{
		...
		final List<String> addonsList = form.getAddons();
		...
		else
		{
			try
			{
				final CartModificationData cartModification = ebookDefaultCartFacade.addToCart(code, qty, addonsList);
				model.addAttribute(QUANTITY_ATTR, Long.valueOf(cartModification.getQuantityAdded()));
				model.addAttribute("entry", cartModification.getEntry());
				model.addAttribute("cartCode", cartModification.getCartCode());
				model.addAttribute("bookAddonsList", addonsList);
