 ...
 *
 */
package com.ebook.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('ebookstorefront.generic.cms.component.controller.authorized.group')}")
