...
<form:form method="post" commandName="ebookRegistrationForm" action="${action}">
	...
	<formElement:formPasswordBox idKey="register.checkPwd"
		...
		<formElement:formInputBox idKey="register.contactNumber"
		labelKey="register.contactNumber" path="contactNumber" inputCSS="form-control" mandatory="true" />
		
		<formElement:formInputBox idKey="register.currentLocation"
		labelKey="register.currentLocation" path="currentLocation" inputCSS="form-control" mandatory="true" />
