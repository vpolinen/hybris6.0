...
import com.ebook.test.constants.EbookTestConstants;
import com.ebook.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EbookTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ebooktest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ebooktest/import/reviews.impex");
			...
			importImpexFile(context, "/ebooktest/import/cstickets.impex");
		}
	}
}
