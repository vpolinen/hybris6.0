 ...
 *  
 */
package com.ebook.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(EbookFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EbookFulfilmentProcessConstants.PARENT_PROCESS);
