 ...
 *  
 */
package com.ebook.cockpits.setup;
...
import com.ebook.cockpits.constants.EbookCockpitsConstants;
 ...
 */
@SystemSetup(extension = EbookCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(EbookCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(EbookCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						EbookCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/ebookcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
