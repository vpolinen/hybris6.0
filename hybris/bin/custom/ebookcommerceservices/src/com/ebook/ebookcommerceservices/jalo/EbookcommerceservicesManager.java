...
/**
 * This is the extension manager of the Ebookcommerceservices extension.
 */
public class EbookcommerceservicesManager extends GeneratedEbookcommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EbookcommerceservicesManager.class.getName());
	 ...
	 */
	public static EbookcommerceservicesManager getInstance()
	{
		return (EbookcommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EbookcommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EbookcommerceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EbookcommerceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EbookcommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EbookcommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
