...
@property (nonatomic) HYBAddressButtonView     *defaultPaymentDetails;

@property (nonatomic) UILabel    *addressBookHeader;
@property (nonatomic) HYBAddressButtonView     *defaultShippingAddress;
