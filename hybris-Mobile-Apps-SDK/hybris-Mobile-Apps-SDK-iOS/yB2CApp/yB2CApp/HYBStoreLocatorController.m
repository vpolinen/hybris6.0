...
- (void)enter {
    ...
    _geolocatorMasterController.listController.customDetailController = [[HYBStoreCustomDetailController alloc] initWithBackEndService:self.backendService];
...
- (void)doPerformSearch {
    ...
    [self.backendService findStoreBySearchQuery:self.currentSearchQuery
